...
then ⟨recipient⟩ is evaluated. Its value must be a procedure of one argument; 
...
#| (cond 
      ((test? exp) (caddr exp)) ; <-- add this cond-clause
) |#

;testing , type these 3 lines when in correct dir:
;(load "4_5.scm")
;(mce)
