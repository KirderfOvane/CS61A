...
;See image 3_11_diagram.jpg for answer. Note that i didn't draw the environments created when invoking dispatch. Every message there creates a environment with m set to the message input.