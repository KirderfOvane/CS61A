...
(define (actual-value exp env) ;exceptions that we need evaluated and cannot be lazy-evalued.
...
(define (eval-if exp env)
  (if (true? (actual-value (if-predicate exp) env)) ;we need the evaluated value to lazy eval the branches
