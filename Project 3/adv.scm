...
;(method (eat)
 ;(print (map (lambda (t) (ask t 'edible? )) (ask self 'possessions )))
;)
(method (eat)
  (map (lambda (t)
                (if (ask t 'edible? )
                  (begin
                    (print "###################")
                    (print "###################")
                    (print "found edible thing: ")
                    (print (ask t 'name ))
                    (print "calories to add to strength: ")
                    (print (ask t 'calories ))
                    (print "person/possessor: ")
                    (print (ask self 'name ))
                    (print "strength before: ")
                    (print (ask self 'strength ))
                    (ask self 'put 'strength (+ (ask self 'strength ) (ask t 'calories )))
                    (print "strength after: ")
                    (print (ask self 'strength ))
                    (print "removing food")
                    (print (ask self 'lose t))
                    (print (ask (ask self 'place ) 'name ))
                    (print "disappear food")
                    (print (ask  (ask self 'place ) 'gone t))
                  )
                  (print (ask t 'name ))
                )
        ) 
